...
The empty state can open the bundled `public/demos/shape-mismatch.prototrace`. It is a real, complete parallel run of the unified SaaS demo: eleven successful scenarios and one intentional shape-mismatch failure. It uses the same archive reader as a user-selected trace.
