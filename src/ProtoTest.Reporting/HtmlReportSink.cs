...
public sealed class HtmlReportSink : IProtoSink, IProtoSinkArtifactSource
{
    ...
    private string Render(ProtoReport report)
    {
        ...
        html.Append("""
            ...
            <header class="topbar">
              <div class="brand">
                <span class="brand-mark" aria-hidden="true"><svg viewBox="0 0 700 700"><path d="M174 112h159c112 0 181 61 181 158s-69 158-181 158h-81v151h-78V112m78 72v172h72c70 0 108-29 108-86s-38-86-108-86h-72M92 356h160v72H92z"/><path class="brand-check" d="m314 470 62 63 166-184"/></svg></span>
    ...
    private const string Styles = """
        ...
        *{scrollbar-width:thin;scrollbar-color:var(--border-strong) transparent}*::-webkit-scrollbar{width:10px;height:10px}*::-webkit-scrollbar-track{background:transparent}*::-webkit-scrollbar-thumb{min-height:36px;border:2px solid transparent;border-radius:999px;background:var(--border-strong);background-clip:padding-box}*::-webkit-scrollbar-thumb:hover{background-color:var(--blueprint)}*::-webkit-scrollbar-corner{background:transparent}
        body{background-color:var(--bg);background-image:linear-gradient(#168ac108 1px,transparent 1px),linear-gradient(90deg,#168ac108 1px,transparent 1px);background-size:28px 28px}.brand-mark{width:36px;height:36px;border-radius:0;color:var(--blueprint);background:none;box-shadow:none}.brand-mark svg{width:36px;height:36px;overflow:visible}.brand-mark path{fill:none;stroke:currentColor;stroke-width:26;stroke-linecap:square;stroke-linejoin:miter}.brand-mark .brand-check{stroke:#0b5278;stroke-width:48}.brand strong{letter-spacing:.02em}.brand small,.eyebrow{text-transform:uppercase}.icon-button{border-color:var(--border-strong)}.generated{font:11px ui-monospace,Consolas,monospace}.coverage-ring,.metric,.report-panel{box-shadow:0 8px 28px var(--shadow)}.metric>strong{font-family:ui-monospace,Consolas,monospace}
