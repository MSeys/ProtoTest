...
Report data is supplied by collectors implementing `IProtoReportSource`. See the [reporting guide](https://github.com/MSeys/ProtoTest/blob/main/docs/docs/advanced/coverage.md).
