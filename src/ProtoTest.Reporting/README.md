...
Report data is supplied by collectors implementing `IProtoReportSource`. See the [reporting guide](https://github.com/matthiasseys/ProtoTest/blob/main/docs/extending/coverage.md).
