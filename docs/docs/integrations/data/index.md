...
- The demo creates and checks data end to end in [`samples/ProtoTest.Demo/SheetsJourney.cs`](https://github.com/MSeys/ProtoTest/blob/main/samples/ProtoTest.Demo/SheetsJourney.cs), with defaults in [`samples/Northstar.ProtoTest/NorthstarData.cs`](https://github.com/MSeys/ProtoTest/blob/main/samples/Northstar.ProtoTest/NorthstarData.cs) and registration in [`samples/ProtoTest.Demo/Setup.cs`](https://github.com/MSeys/ProtoTest/blob/main/samples/ProtoTest.Demo/Setup.cs).
