    ...
    private string Render(ProtoReport report)
    {
        ...
        html.Append("""
            ...
            <main>
              <section class="hero">
                <div>
                  <p class="eyebrow">TEST INSIGHTS</p>
            """);
