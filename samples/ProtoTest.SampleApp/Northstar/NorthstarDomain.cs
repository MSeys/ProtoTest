...
internal sealed class Organization
{
    ...
    public Dictionary<string, Membership> Members { get; } = new(StringComparer.OrdinalIgnoreCase);
    public Dictionary<string, ApiToken> Tokens { get; } = new(StringComparer.Ordinal);
    public Dictionary<string, Project> Projects { get; } = new(StringComparer.OrdinalIgnoreCase);
    ...
    public int BillableSeats => Members.Values.Count(member => member.Status != MemberStatuses.Removed);
...
internal sealed class Project
{
    ...
    public required DateTimeOffset CreatedAtUtc { get; init; }
    public Dictionary<string, Environment> Environments { get; } = new(StringComparer.OrdinalIgnoreCase);
}
